...
namespace AnalizadorDeLexico.Controllers
{
    public class UploadFileController : Controller
    {
        ...
        // GET: FileUpload
        public ActionResult IndexArchivo()
        {
        ...
        public ActionResult IndexArchivo(HttpPostedFileBase file)
        {
        ...
        public ActionResult ReadArchivo(string TxtName)
        {
            if (Path.GetExtension(TxtName) == ".txt")
            {
                return RedirectToAction("Archivo", "ReadText", new { filename = TxtName });
            }
            else
            {
